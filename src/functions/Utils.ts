...
export function findSimilarIngredients(ingredients: Ingredient[], name: string, threshold: number): SimilarIngredient[] {
...
export function diceCoefficient(a: string, b: string): number {
    ...
    const matches = aBigrams.filter(bigram => bBigrams.includes(bigram)).length;
